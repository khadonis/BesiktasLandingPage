...
function validFunc(e,t,a,i,n,l,r,s,m){$(e).click(function(o){var d=$(t).val(),u=$(a).val(),f=$(i).val(),c=($(n).val(),$(l).val(),$(r).val(),/^[A-Za-zşŞıİçÇöÖüÜĞğ ]+$/),y=/^[0-9]+$/,v=$(s),g=$(m);""==d?(swal({title:"Uyarı!",text:"Lütfen adınızı giriniz",type:"warning",confirmButtonText:"OK"}),o.preventDefault()):c.test(d)?""==u?(swal({title:"Uyarı!",text:"Lütfen soyadınızı giriniz",type:"warning",confirmButtonText:"OK"}),o.preventDefault()):c.test(u)?""==f?(swal({title:"Uyarı!",text:"Lütfen telefon numaranızı giriniz",type:"warning",confirmButtonText:"OK"}),o.preventDefault()):y.test(f)?v.is(":checked")||g.is(":checked")?$(e).click(function(){return!0}):(swal({title:"Uyarı!",text:"Lütfen yasal uyarıyı kabul edip etmediğinizi belirtiniz",type:"warning",confirmButtonText:"OK"}),o.preventDefault()):(swal({title:"Uyarı!",text:"Lütfen geçerli bir telefon numarası giriniz",type:"warning",confirmButtonText:"OK"}),o.preventDefault()):(swal({title:"Uyarı!",text:"Lütfen geçerli bir soyad giriniz",type:"warning",confirmButtonText:"OK"}),o.preventDefault()):(swal({title:"Uyarı!",text:"Lütfen geçerli bir ad giriniz",type:"warning",confirmButtonText:"OK"}),o.preventDefault())})}$(document).ready(function(){document.body.className+=" is-loaded",$("#ad").keyup(function(){$(".slider-text img").removeClass("visible"),$(".slider-text img").addClass("hidden"),$(this).val().length>0?$("#userName").text($(this).val()+","):($("#userName").text($(this).val()),$(".slider-text img").addClass("visible"),$(".slider-text img").removeClass("hidden"))})}),validFunc("#submit","#ad","#soyad","#tel","#email","#proje","#mesaj","#ke","#kt"),$("#legalWarning").click(function(){swal({title:"Uyarı!",text:"Formda yer alan her türlü kişisel bilgimin, DKY pazarlama faaliyetlerinde, kampanyalarında, reklamlarında, tanıtımlarında ve iletişim çalışmalarında paylaşılmasına, işlenebilmesine, kullanılmasına, saklanmasına, tarafıma sms, mms, email gönderilmesine, sesli arama yapılmasına ve posta gönderilmesine muvafakat ediyor ve izin veriyorum.",type:"warning",confirmButtonText:"OK"})}),$.browser.chrome=$.browser.webkit&&!!window.chrome,$.browser.chrome&&$("html").addClass("webkit");
